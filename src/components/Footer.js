...
function Footer() {
	return (
		<div className="container footer border-top pt-3">
            ...
            <p className="text-secondary">No: 296, 3rd Cross Rd, Jakkasandra, 1st Block, Koramangla</p>
            ...
            <div className="d-flex justify-content-between flex-column flex-sm-row mb-3">
                <div className="mb-2">
                    ...
                    <a href="#!" className="text-secondary mr-4">Contact</a>
                    <a href="#!" className="text-secondary mr-4">About</a>
                </div>
                <div>
                    <a href="#!" className="text-secondary mr-4">Privacy Policy</a>
